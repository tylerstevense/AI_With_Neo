package com.example.nilotpal.aichatbot;
...
import com.example.nilotpal.aichatbot.Adapter.CustomAdapter;
import com.example.nilotpal.aichatbot.Helper.HttpDataHandler;
import com.example.nilotpal.aichatbot.Models.AIModel;
import com.example.nilotpal.aichatbot.Models.ChatModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class SimsimiAPI extends AsyncTask<List<ChatModel>, Void, String> {
        ...
        protected void onPostExecute(String s) {
            Gson gson = new Gson();
            AIModel response = gson.fromJson(s, AIModel.class);
